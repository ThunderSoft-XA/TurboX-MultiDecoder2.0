...
extern "C"
JNIEXPORT void JNICALL
Java_com_thundercomm_libyuv_util_YuvUtil_yuvCropI420(JNIEnv *env, jclass jcls, jbyteArray src_, jint width,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_thundercomm_libyuv_util_YuvUtil_yuvMirrorI420(JNIEnv *env, jclass jcls, jbyteArray i420Src,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_thundercomm_libyuv_util_YuvUtil_yuvScaleI420(JNIEnv *env, jclass jcls, jbyteArray i420Src,
                                          jint width, jint height, jbyteArray i420Dst,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_thundercomm_libyuv_util_YuvUtil_yuvRotateI420(JNIEnv *env, jclass jcls, jbyteArray i420Src,
                                           jint width, jint height, jbyteArray i420Dst,
                                           jint degree) {
    jbyte *src_i420_data = env->GetByteArrayElements(i420Src, NULL);
    jbyte *dst_i420_data = env->GetByteArrayElements(i420Dst, NULL);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_thundercomm_libyuv_util_YuvUtil_yuvNV21ToI420(JNIEnv *env, jclass jcls, jbyteArray nv21Src,
                                           jint width, jint height, jbyteArray i420Dst) {
    jbyte *src_nv21_data = env->GetByteArrayElements(nv21Src, NULL);
    jbyte *dst_i420_data = env->GetByteArrayElements(i420Dst, NULL);
    // nv21转化为i420
...
extern "C"
JNIEXPORT void JNICALL
Java_com_thundercomm_libyuv_util_YuvUtil_yuvI420ToNV21(JNIEnv *env, jclass jcls, jbyteArray i420Src,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_thundercomm_libyuv_util_YuvUtil_yuvNV21ToI420AndRotate(JNIEnv *env, jclass jcls, jbyteArray nv21Src,
                                                    jint width, jint height, jbyteArray i420Dst,
                                                    jint degree) {
    jbyte *src_nv21_data = env->GetByteArrayElements(nv21Src, NULL);
    jbyte *dst_i420_data = env->GetByteArrayElements(i420Dst, NULL);
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvI420ToRGB24
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvI420ToARGB
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvI420ToRGBAMac
        (JNIEnv *env, jclass jcls, jbyteArray i420Src, jint width, jint height, jint dst_stride,
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvI420ToARGB4444
        (JNIEnv *env, jclass jcls, jbyteArray i420Src, jint width, jint height, jint dst_stride,
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvI420ToRGB565
        (JNIEnv *env, jclass jcls, jbyteArray i420Src, jint width, jint height,
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvI420ToRGB565Android
        (JNIEnv *env, jclass jcls, jbyteArray i420Src, jint width, jint height,
         jbyteArray rgb565Dst) {
    jbyte *src_i420_data = env->GetByteArrayElements(i420Src, NULL);
    jbyte *dst_rgb565_data = env->GetByteArrayElements(rgb565Dst, NULL);
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvI420ToARGB1555
        (JNIEnv *env, jclass jcls, jbyteArray i420Src, jint width, jint height, jint dst_stride,
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvI420ToYUY2
        (JNIEnv *env, jclass jcls, jbyteArray i420Src, jint width, jint height, jint dst_stride,
         jbyteArray yuy2Dst) {
    jbyte *src_i420_data = env->GetByteArrayElements(i420Src, NULL);
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvI420ToUYVY
        (JNIEnv *env, jclass jcls, jbyteArray i420Src, jint width, jint height, jint dst_stride,
         jbyteArray uyvyDst) {
    jbyte *src_i420_data = env->GetByteArrayElements(i420Src, NULL);
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvI420ToYV12
        (JNIEnv *env, jclass jcls, jbyteArray i420Src, jint width, jint height, jint dst_stride,
         jbyteArray yv12Dst) {
    jbyte *src_i420_data = env->GetByteArrayElements(i420Src, NULL);
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvYV12ToI420
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvNV12ToI420
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvI420ToNv12
        (JNIEnv *env, jclass jcls, jbyteArray i420Src, jint width, jint height,
         jbyteArray nv12Dst) {
    jbyte *src_i420_data = env->GetByteArrayElements(i420Src, NULL);
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvNV12ToI420AndRotate
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvNV12ToRGB565
        (JNIEnv *env, jclass jcls, jbyteArray nv12Src, jint width, jint height,
         jbyteArray rgb565Dst) {
    jbyte *src_nv12_data = env->GetByteArrayElements(nv12Src, NULL);
    jbyte *dst_rgb565_data = env->GetByteArrayElements(rgb565Dst, NULL);
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvI420ToRGBAIPhone
        (JNIEnv *env, jclass jcls, jbyteArray i420Src, jint width, jint height, jint dst_stride,
         jbyteArray rgbaDst) {
    jbyte *src_i420_data = env->GetByteArrayElements(i420Src, NULL);
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvI420Copy
        (JNIEnv *env, jclass jcls, jbyteArray i420Src, jint width, jint height, jint dst_stride,
         jbyteArray i420Dst) {
    jbyte *src_i420_data = env->GetByteArrayElements(i420Src, NULL);
    jbyte *dst_i420_data = env->GetByteArrayElements(i420Dst, NULL);
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvUYVYToI420
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvYUY2ToI420
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvRGB24ToARGB
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvRGB24ToI420
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvI420ToARGBMac
        (JNIEnv *env, jclass jcls, jbyteArray i420Src, jint width, jint height, jint dst_stride,
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvARGBMacToI420
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvMirrorI420LeftRight
        (JNIEnv *env, jclass jcls, jbyteArray i420Src, jint width, jint height,
         jbyteArray i420Dst) {
    jbyte *src_i420_data = env->GetByteArrayElements(i420Src, NULL);
    jbyte *dst_i420_data = env->GetByteArrayElements(i420Dst, NULL);
...
extern "C"
JNIEXPORT void JNICALL Java_com_thundercomm_libyuv_util_YuvUtil_yuvMirrorI420UpDown
        (JNIEnv *env, jclass jcls, jbyteArray i420Src, jint width, jint height,
         jbyteArray i420Dst) {
    jbyte *src_i420_data = env->GetByteArrayElements(i420Src, NULL);
    jbyte *dst_i420_data = env->GetByteArrayElements(i420Dst, NULL);
